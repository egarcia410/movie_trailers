...
godfather = media.Movie("The Godfather",
                        # Storyline is divided onto multiple lines
                        "The aging patriarch of an organized"
                        " crime dynasty transfers"
                        " control of his clandestine empire"
                        " to his reluctant son",
                        "https://s-media-cache-ak0.pinimg.com/736x/ac/4a"\
                        "/37/ac4a37918747beecd329863d3defb368.jpg",
...
raging_bull = media.Movie("Raging Bull",
                          ...
                          "An emotionally self-destructive"
                          " boxer's journey through life, as the"
                          " violence and temper"
                          " that leads him to"
                          " the top in the ring destroys his life outside it",
                          "https://upload.wikimedia.org/wikipedia/"\
                          "en/5/5f/Raging_Bull_poster.jpg",
                          "https://www.youtube.com/watch?v=mHhzOM4gBIA")

casablanca = media.Movie("Casablanca",
                         # Storyline is divided onto two lines
                         "In Casablanca, Morocco in"
                         " December 1941, a cynical American"
                         " expatriate meets"
                         " a former lover,"
                         " with unforeseen complications",
                         "https://www.movieposter.com/posters/"\
                         "archive/main/27/MPW-13851",
                         "https://www.youtube.com/watch?v=a2MnKebNlRo")

citizen_kane = media.Movie("Citizen Kane",
                           # Storyline is divided onto two lines
                           "Following the death of a publishing"
                           " tycoon, news reporters"
                           " scramble to discover the meaning"
                           " of his final utterance",
                           "https://67.media.tumblr.com/d2a1fdd5ff50697"\
                           "c6292bdbf6444568a/tumblr_"\
                           "mm43onrWgy1s80h8lo1_500.png",
                           "https://www.youtube.com/watch?v=8dxh3lwdOFw")

# The 6 Movies instances are placed inside an array called "movies"
movies = [godfather, shawshank, schindler,
          raging_bull, casablanca, citizen_kane]
# The array "movies" is inserted into a function open_movies_page
